...
class AttendanceFilterSection extends StatefulWidget {
  ...
  @override
  State<AttendanceFilterSection> createState() => _AttendanceFilterSectionState();
}
...
class _AttendanceFilterSectionState extends State<AttendanceFilterSection> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<ParalelosProvider, MateriasProvider, AsistenciasProvider>(
      builder: (context, paralelosProvider, materiasProvider,
          asistenciasProvider, child) {
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: _buildParaleloItems(
                            paralelos, paralelosProvider.isLoading),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        onChanged: materiasProvider.isLoading ||
                                paraleloSeleccionado == null
                            ? null
                            : (value) =>
                ...
                const SizedBox(width: 20),
                FilledButton.icon(
                  onPressed: _selectedMateriaId != null && _selectedParaleloId != null
                      ? () {
  ...
  List<DropdownMenuItem<int>> _buildParaleloItems(
      List<ParaleloItem> paralelos, bool isLoading) {
